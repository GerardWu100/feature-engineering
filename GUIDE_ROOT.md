...
- 2026-09-08: Added triple-barrier targets (decision-driven holding period instead of a fixed N bars) with three config blocks, and `docs/reference/decision_driven_labels.md` surveying alternatives to fixed-horizon targets. The Fable 5.1 review `fable_thoughts_2026-09-08.md` records that no prior integration recommendation had been acted on and ranks the next steps.
